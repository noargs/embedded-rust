## Creare project     
`cargo new led_button_interrupt`    

   
> [!IMPORTANT]           
> `.vscode/launch.json` should contain right location for `"svdFile"` depending on your OS.  
> it should also contain right project executable location i.e. `"executable"`     
